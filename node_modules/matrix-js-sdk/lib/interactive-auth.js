...
InteractiveAuth.prototype = {
  ...
  attemptAuth: function () {
    ...
    return new Promise((resolve, reject) => {
      ...
      this._rejectFunc = reject; // if we have no flows, try a request (we'll have
   ...
   */
  poll: async function () {
    if (!this._data.session) return; // if we currently have a request in flight, there's no point making
